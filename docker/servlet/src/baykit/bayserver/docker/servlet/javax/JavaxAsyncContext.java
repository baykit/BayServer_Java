...
public class JavaxAsyncContext extends ASyncContextDuck implements AsyncContext {


    public JavaxAsyncContext(Object req, Object res, boolean original, ServletDocker docker) {

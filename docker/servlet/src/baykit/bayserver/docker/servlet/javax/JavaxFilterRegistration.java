...
import baykit.bayserver.docker.servlet.duck.DispatcherTypeDuck;
...
public class JavaxFilterRegistration extends FilterRegistrationDuck implements FilterRegistration.Dynamic {


    public JavaxFilterRegistration(String name, String className, ServletContextDuck ctx) {
        super(name, className, ctx);
    }

    public JavaxFilterRegistration(String name, Object filter, ServletContextDuck ctx) {

...
import yokohama.baykit.bayserver.docker.servlet.duck.ServletOutputStreamModule;
import javax.servlet.*;
import yokohama.baykit.bayserver.docker.servlet.duck.HttpServletResponseDuck;

import java.io.IOException;

class JavaxServletOutputStream extends ServletOutputStream {

    // like mix-in
    private final ServletOutputStreamModule module;

    JavaxServletOutputStream(HttpServletResponseDuck res, String charset){

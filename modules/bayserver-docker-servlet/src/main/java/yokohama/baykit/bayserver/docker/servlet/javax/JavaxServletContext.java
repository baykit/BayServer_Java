...
/**
 * Implementation of ServletContext for javax
 * 
 */
class JavaxServletContext extends ServletContextDuck implements ServletContext {
    
    public JavaxServletContext(String name, String ctxPath, String realPath, ServletDocker docker) {
    ...
    public Map<String, ? extends ServletRegistration> getServletRegistrations() {
        ...
        if(ducks == null)
            return null;
        Map<String, JavaxServletRegistration> regs = new HashMap<>();
        for(String name : ducks.keySet()) {
            regs.put(name,  (JavaxServletRegistration)ducks.get(name));
        }
        return regs;
    }
    ...
    public Map<String, ? extends FilterRegistration> getFilterRegistrations() {
        ...
        if(ducks == null)
            return null;
        Map<String, JavaxFilterRegistration> regs = new HashMap<>();
        for(String name : ducks.keySet()) {
            regs.put(name,  (JavaxFilterRegistration)ducks.get(name));
        }
        return regs;
    }
